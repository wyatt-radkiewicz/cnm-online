...
#define OLD_TELEPORT_INFOS_MAX_TELEPORTS 512
#define TELEPORT_INFOS_MAX_TELEPORTS 128
#define OLD_TELEPORT_NAMESZ (UTIL_MAX_TEXT_WIDTH + 1)
#define TELEPORT_NAMESZ (20+1)
